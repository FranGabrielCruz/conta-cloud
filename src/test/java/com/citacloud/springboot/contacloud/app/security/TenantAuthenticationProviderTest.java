...
class TenantAuthenticationProviderTest {
    ...
    @Test void autenticaSiempreConEmpresaYUsuarioCombinados() {
        ...
        when(accesos.findByEmpresaIdAndUsuarioUsuarioIgnoreCaseAndActivoTrueAndUsuarioActivoTrue(empresaId,"admin")).thenReturn(Optional.of(acceso));
        ...
        verify(accesos).findByEmpresaIdAndUsuarioUsuarioIgnoreCaseAndActivoTrueAndUsuarioActivoTrue(empresaId,"admin");
    }
    ...
    @Test void rechazaUsuarioQueNoTieneAccesoEnLaEmpresaIndicada() {
        ...
        when(accesos.findByEmpresaIdAndUsuarioUsuarioIgnoreCaseAndActivoTrueAndUsuarioActivoTrue(empresaId,"admin")).thenReturn(Optional.empty());
        var provider=new TenantAuthenticationProvider(empresas,usuarios,accesos,sucursales,encoder);
