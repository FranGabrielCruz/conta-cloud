...
public class BranchService {
    ...
    @Transactional(readOnly = true) @PreAuthorize("@moduleAuthorization.enabled('CONFIGURACION') and hasAuthority('SUCURSAL_VER')")
    ...
    @Transactional @PreAuthorize("@moduleAuthorization.enabled('CONFIGURACION') and hasAuthority('SUCURSAL_CREAR')")
    ...
    @Transactional @PreAuthorize("@moduleAuthorization.enabled('CONFIGURACION') and hasAuthority('SUCURSAL_EDITAR')")
    ...
    @Transactional @PreAuthorize("@moduleAuthorization.enabled('CONFIGURACION') and hasAuthority('SUCURSAL_DESACTIVAR')")
