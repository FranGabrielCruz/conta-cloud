...
public class CompanyCurrencyService {
    ...
    @Transactional(readOnly = true) @PreAuthorize("@moduleAuthorization.enabled('CONFIGURACION') and hasAuthority('MONEDA_VER')")
    ...
    @Transactional(readOnly = true) @PreAuthorize("@moduleAuthorization.enabled('CONFIGURACION') and hasAnyAuthority('MONEDA_VER','EMPRESA_VER')")
    ...
    @Transactional @PreAuthorize("@moduleAuthorization.enabled('CONFIGURACION') and hasAuthority('MONEDA_CREAR')")
    ...
    @Transactional @PreAuthorize("@moduleAuthorization.enabled('CONFIGURACION') and hasAuthority('MONEDA_EDITAR')")
    ...
    @Transactional @PreAuthorize("@moduleAuthorization.enabled('CONFIGURACION') and hasAuthority('MONEDA_DESACTIVAR')")
